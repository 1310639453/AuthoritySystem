	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<ol class="breadcrumb">
				...
				<li><a
					href="${pageContext.request.contextPath}/sysLog/findAll/1/10">日志管理</a></li>
					...
					<div class="box-tools pull-right">
						<ul class="pagination">
							...
							<c:forEach begin="1" end="${pageInfo.pages}" varStatus="s">
								...
								<c:if test="${pageInfo.pageNum != s.current}">
									<li><a href="${pageContext.request.contextPath}/sysLog/findAll/${s.current}/${pageInfo.pageSize}">${s.current}</a></li>
								</c:if>
							</c:forEach>
	...
	<script>
		$(function () {
			onPageSizeChange = function () {
				...
				location.href = "${pageContext.request.contextPath}/sysLog/findAll/1/"+pageSize;
			}
		});
